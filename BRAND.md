...
2. **Kein Doppelinhalt im Test:** während `neu.v-zo.ch` läuft → `noindex,nofollow` in die Seiten. **Beim Switch sofort entfernen**, sonst wird die Live-Seite nicht indexiert.
